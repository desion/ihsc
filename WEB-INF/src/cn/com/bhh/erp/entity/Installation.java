...
public class Installation implements Serializable {
    ...
    private String nowRepairMainCompanyName;
    private String firstRepairMainCompanyName;
    ...
    private String sort;
    private String manufactureNoStart;
    private String manufactureNoEnd;
    private String startDate;
    private String sortType;
    private String saleContractCompShortName;
    private String installCompShortName;
    //2009/08/20 add
    private BigDecimal osPermitId;
    private String osPermitName;
    private Integer userCompanyBankId;
    private Integer userCompanyProvinceId;
    private Integer userCompanyCityId;
    ...
    /**
     * @param branchCompanyName the branchCompanyName to set
     */
    ...
    /**
     * @return manufactureNoStart
     */
    public String getManufactureNoStart() {
        return manufactureNoStart;
    }

    /**
     * @param manufactureNoStart
     */
    public void setManufactureNoStart(String manufactureNoStart) {
        this.manufactureNoStart = manufactureNoStart;
    }

    /**
     * @return manufactureNoEnd
     */
    public String getManufactureNoEnd() {
        return manufactureNoEnd;
    }

    /**
     * @param manufactureNoEnd
     */
    public void setManufactureNoEnd(String manufactureNoEnd) {
        this.manufactureNoEnd = manufactureNoEnd;
    }
    ...
    /**
     * @param repairCompanyId the nowRepairCompanyId to set
     */
    public void setRepairCompanyId(Integer repairCompanyId) {
        this.nowRepairCompanyId = repairCompanyId;
    }
    ...
    /**
     * @param customerProvinceId the customerProvinceId to set
     */
    ...
    /**
     * @return the customerMainName
     */
    public String getCustomerMainName() {
        return customerMainName;
    }

    /**
     * @param customerMainName the customerMainName to set
     */
    public void setCustomerMainName(String customerMainName) {
        this.customerMainName = customerMainName;
    }

    /**
     * @return the customerSubName
     */
    ...
    /**
     * @param customerSubName the customerSubName to set
     */
    public void setCustomerSubName(String customerSubName) {
        this.customerSubName = customerSubName;
    }

    /**
     * @return the nowRepairMainCompanyName
     */
    public String getNowRepairMainCompanyName() {
        return nowRepairMainCompanyName;
    }

    /**
     * @param nowRepairMainCompanyName the nowRepairMainCompanyName to set
     */
    public void setNowRepairMainCompanyName(String nowRepairMainCompanyName) {
        this.nowRepairMainCompanyName = nowRepairMainCompanyName;
    }

    /**
     * @return the firstRepairMainCompanyName
     */
    public String getFirstRepairMainCompanyName() {
        return firstRepairMainCompanyName;
    }

    /**
     * @param firstRepairMainCompanyName the firstRepairMainCompanyName to set
     */
    public void setFirstRepairMainCompanyName(String firstRepairMainCompanyName) {
        this.firstRepairMainCompanyName = firstRepairMainCompanyName;
    }
    ...
    /**
     * @return the saleContractCompShortName
     */
    public String getSaleContractCompShortName() {
        return saleContractCompShortName;
    }

    /**
     * @param saleContractCompShortName the saleContractCompShortName to set
     */
    public void setSaleContractCompShortName(String saleContractCompShortName) {
        this.saleContractCompShortName = saleContractCompShortName;
    }

    /**
     * @return the installCompShortName
     */
    public String getInstallCompShortName() {
        return installCompShortName;
    }

    /**
     * @param installCompShortName the installCompShortName to set
     */
    public void setInstallCompShortName(String installCompShortName) {
        this.installCompShortName = installCompShortName;
    }
    ...
    /**
     * @return the userCompanyBankId
     */
    public Integer getUserCompanyBankId() {
        return userCompanyBankId;
    }

    /**
     * @param userCompanyBankId the userCompanyBankId to set
     */
    public void setUserCompanyBankId(Integer userCompanyBankId) {
        this.userCompanyBankId = userCompanyBankId;
    }

    /**
     * @return the userCompanyProvinceId
     */
    public Integer getUserCompanyProvinceId() {
        return userCompanyProvinceId;
    }

    /**
     * @param userCompanyProvinceId the userCompanyProvinceId to set
     */
    public void setUserCompanyProvinceId(Integer userCompanyProvinceId) {
        this.userCompanyProvinceId = userCompanyProvinceId;
    }

    /**
     * @return the userCompanyCityId
     */
    public Integer getUserCompanyCityId() {
        return userCompanyCityId;
    }

    /**
     * @param userCompanyCityId the userCompanyCityId to set
     */
    public void setUserCompanyCityId(Integer userCompanyCityId) {
        this.userCompanyCityId = userCompanyCityId;
    }
