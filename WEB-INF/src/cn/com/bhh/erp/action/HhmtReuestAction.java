...
public class HhmtReuestAction extends BaseAction {
    ...
    public String SearchHHMTList()throws Exception {
        ...
        int totalNum = customerBussiness.getChannelAccuCount(channelAccumu, loginUser);
        setTotalCount(totalNum);
        channelAccumuList = customerBussiness.searchChannelAccuList(channelAccumu, loginUser,currPage, pageSize);
