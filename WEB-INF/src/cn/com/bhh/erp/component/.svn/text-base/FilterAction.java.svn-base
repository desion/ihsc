 ...
 * the actions from action_tbl,and select
 * the group actions from action_group_tbl
 * according to the groupId
 * @author  xiangzq
 * @version 1.0
 * @since   1.0
 */
...
public class FilterAction extends BaseAction {
    ...
    public void initData() {
        ...
        if (selectedGroupId == null) {
            actionList = ab.getActionByType(2);
        }else{
            actionList = ab.getActionsByGroupAndType(selectedGroupId,2);
        }
    }
