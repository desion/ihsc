...
<head>
<title><@s.text name="fault_handle_modify" /></title>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#endDate").datepicker();
        textCounter('detail','detailLeft');
        textCounter('result','resultLeft');
        textCounter('note','noteLeft');
    });
 ...
 <#include "../header.ftl"/>
  <div id="view">
    <div class="fields">
                    ...
                    <td>          
			            <table class="field_tbl" width="100%" align="center">
			              ...
			              <tr>
			                ...
			                <td width="80%" colspan="3">
			                    <textarea id="detail" name="faultHandle.handleDetail" rows="2" cols="50" style="overflow-y:auto" 
			                    onPropertyChange=textCounter('detail','detailLeft') oninput=textCounter('detail','detailLeft')>${faultHandle.handleDetail!""}</textarea>
			              ...
			              <tr>
			                ...
			                <td width="80%" colspan="3">
			                    <textarea id="result" name="faultHandle.status" rows="2" cols="50" style="overflow-y:auto" 
			                    onPropertyChange=textCounter('result','resultLeft') oninput=textCounter('result','resultLeft')>${faultHandle.status!""}</textarea>
			                        &nbsp;<label class="needed"><@s.text name="writeNeeded2" /></label>
			              ...
			              <tr>
			                ...
			                <td width="80%" colspan="3">
			                    <textarea id="note" name="faultHandle.note" rows="2" cols="50" style="overflow-y:auto" 
			                    onPropertyChange=textCounter('note','noteLeft') oninput=textCounter('note','noteLeft')>${faultHandle.note!""}</textarea>
      ...
      <div class="btn_row">
         <#if loginUser.hasPermission("FA002_31")>
            <button type="button" onClick="changeAction('FA002_31')" ><@s.text name="btn_modify" /></button>
         </#if>   
      </div>
    </div>
  </div>
