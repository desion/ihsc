...
<head>
<title><@s.text name="modify.product.label.title" /></title>
...
<div id="container">
  <#include "../header.ftl"/>
   <div id="view" >
     <div class="fields">
       <form id="mdfForm" action="PR002_31" method="post">
          <div>
              <table>
                <#noescape>
	                <td><@s.text name="modify.product.label.productCategory" />${navigationString!""}</td>
	            </#noescape>
	          </table>
	       </div>
	              ...
	              <tr>
	                <td>          
			            <table width="70%" align="center" class="field_tbl">
			                <tbody>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.model" /></td>
			                        <td width="80%">
			                    ...
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.producer" /></td>
			                        <td width="80%">
			                    ...
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.category" /></td>
			                        <td width="80%">
                  ...
                  <tr>
                    <td>             
			            <table width="70%" align="center" class="field_tbl">
			                <tbody>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.operationType" /></td>
			                        <td width="80%">
                  ...
                  <tr>
                    <td>             
			            <table width="70%" align="center" class="field_tbl">
			                <tbody>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.runtimeTemp" /></td>
			                        <td width="80%"><input type="text" name="product.runtimeTemp" value="${product.runtimeTemp!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.standbyTemp" /></td>
			                        <td width="80%"><input type="text" name="product.standbyTemp" value="${product.standbyTemp!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.humidity" /></td>
                  ...
                  <tr>
                    <td>             
			            <table width="70%" align="center" class="field_tbl">
			                <tbody>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.runtimeHeat" /></td>
			                        <td width="80%"><input type="text" name="product.runtimeHeat" value="${product.runtimeHeat!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.standbyHeat" /></td>
                  ...
                  <tr>
                    <td>              
			            <table width="70%" align="center" class="field_tbl">
			                <tbody>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerLcd" /></td>
			                        <td width="80%"><input type="text" name="product.customerLcd" value="${product.customerLcd!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerInput1" /></td>
			                        <td width="80%"><input type="text" name="product.customerInput1" value="${product.customerInput1!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerInput2" /></td>
			                        <td width="80%"><input type="text" name="product.customerInput2" value="${product.customerInput2!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerInput3" /></td>
			                        <td width="80%"><input type="text" name="product.customerInput3" value="${product.customerInput3!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerInput4" /></td>
			                        <td width="80%"><input type="text" name="product.customerInput4" value="${product.customerInput4!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerInput5" /></td>
			                        <td width="80%"><input type="text" name="product.customerInput5" value="${product.customerInput5!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerLoudspeaker" /></td>
			                        <td width="80%">
			                            <#if (customerLoudspeakerSel?? && customerLoudspeakerSel == "1")>
			                                <input type="radio" id="radio_cl" name="customerLoudspeakerSel" value="1" checked/><@s.text name="modify.product.label.customerLoudspeaker.has" />
			                                <input type="radio" id="radio_cl" name="customerLoudspeakerSel" value="0"/><@s.text name="modify.product.label.customerLoudspeaker.hasnot" />
			                            <#elseif (customerLoudspeakerSel?? && customerLoudspeakerSel == "0")>
			                                <input type="radio" id="radio_cl" name="customerLoudspeakerSel" value="1"/><@s.text name="modify.product.label.customerLoudspeaker.has" />
			                                <input type="radio" id="radio_cl" name="customerLoudspeakerSel" value="0" checked/><@s.text name="modify.product.label.customerLoudspeaker.hasnot" />
			                            <#else>
			                                <input type="radio" id="radio_cl" name="customerLoudspeakerSel" value="1"/><@s.text name="modify.product.label.customerLoudspeaker.has" />
			                                <input type="radio" id="radio_cl" name="customerLoudspeakerSel" value="0"/><@s.text name="modify.product.label.customerLoudspeaker.hasnot" />
			                            </#if>
			                    ...
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.customerVoiceWizard" /></td>
			                        <td width="80%">
			                            <#if (customerVoiceWizardSel?? && customerVoiceWizardSel == "1")>
			                                <input type="radio" id="radio_cvw" name="customerVoiceWizardSel" value="1" checked/><@s.text name="modify.product.label.customerVoiceWizard.has" />
			                                <input type="radio" id="radio_cvw" name="customerVoiceWizardSel" value="0"/><@s.text name="modify.product.label.customerVoiceWizard.hasnot" />
			                            <#elseif (customerVoiceWizardSel?? && customerVoiceWizardSel == "0")>
			                                <input type="radio" id="radio_cvw" name="customerVoiceWizardSel" value="1"/><@s.text name="modify.product.label.customerVoiceWizard.has" />
			                                <input type="radio" id="radio_cvw" name="customerVoiceWizardSel" value="0" checked/><@s.text name="modify.product.label.customerVoiceWizard.hasnot" />
			                            <#else>
			                                <input type="radio" id="radio_cvw" name="customerVoiceWizardSel" value="1"/><@s.text name="modify.product.label.customerVoiceWizard.has" />
			                                <input type="radio" id="radio_cvw" name="customerVoiceWizardSel" value="0"/><@s.text name="modify.product.label.customerVoiceWizard.hasnot" />
			                            </#if>
			                    ...
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.administratorLcd" /></td>
			                        <td width="80%"><input type="text" name="product.administratorLcd" value="${product.administratorLcd!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.administratorInput" /></td>
			                        <td width="80%"><input type="text" name="product.administratorInput" value="${product.administratorInput!""}" maxLength="80" size="80"/></td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="modify.product.label.operationSystem" /></td>
          ...
          <div class="btn_row">
             <#if loginUser.hasPermission("PR002_31")>
                <button type="button" onClick="changeAction('PR002_31')"><@s.text name="btn_modify" /></button>
             </#if>   
          </div>
        </div>
     </div>
