                ...
                <td>          
		                ...
		                <tbody>
		                    <tr>
		                        <td style="border-top:0px;border-left:0px;border-right:0px;" colspan="6">
		                            <@s.text name="view.fault.label.atmFaultInfo" />
		                        </td>
		                    </tr>
		                    <tr>
		                    ...
		                    <tr>
		                        <td width="12%" class="lcell"><@s.text name="view.fault.label.brmEpVer" /></td>
		                        <td width="21%">${fault.brmEpVer!""}</td>
		                        <td width="12%" class="lcell"><@s.text name="view.fault.label.bvEpVer" /></td>
		                        <td width="21%">${fault.bvEpVer!""}</td>
		            ...
		            <table style="margin-top:0px;table-layout:fixed" width="80%" align="center" class="field_tbl">
		                <tbody>
		                    ...
		                    <tr>
		                        ...
		                        <td width="20%">${fault.errorCode!""}</td>
		                        <td width="16%" class="lcell"><@s.text name="view.fault.label.rx278" /></td>
		                        <td width="17%">${fault.rx278!""}</td>
		                        <td width="16%" class="lcell"><@s.text name="view.fault.label.counter" /></td>
		                        <td width="19%">${fault.counter!""}</td>
		                    </tr>
		                    <tr>
		                        <td width="10%" class="lcell"><@s.text name="view.fault.label.appearance" /></td>
		                        <td width="88%" colspan="5">${fault.appearance!""}</td>
		                    </tr>
		                    <tr>
		                        <td width="10%" class="lcell" id="faultreason"><@s.text name="view.fault.label.reason" /></td>
		                        <td width="88%" colspan="5">${fault.reason!""}</td>
		                    </tr>
		                    <tr>
		                        <td width="10%" style="border-bottom:none" class="lcell" id="faultstrategy"><@s.text name="view.fault.label.strategy" /></td>
		                        <td width="71%" style="border-bottom:none;border-right:none" colspan="4">${fault.strategy!""}</td>
		                    ...
		                    <tr id="tr_strategyDetail">
		                        ...
		                        <td id="td_strategyDetail2" width="88%" style="display:none;word-break:break-all;word-wrap:break-word;" colspan="5">${fault.strategyDetail!""}</td>
		                    </tr>
		                    <tr>
		                        <td width="10%" id="faultresultId" class="lcell"><@s.text name="view.fault.label.result" /></td>
		                        <td width="88%"  colspan="5">${fault.result!""}</td>
		                    </tr>
		                </tbody>
		            </table>
		            ...
		            <div id="detailPhase" style="display:none;position:relative;">
		                ...
		                <table style="margin-top:0px;table-layout:fixed" width="100%" align="center" class="field_tbl">
		                    <tbody>
		                        ...
		                        <tr>
		                            <td width="98%" colspan="4">
		                                <@s.text name="view.fault.label.msg3" />
		                        ...
		                        <tr>
		                            <td width="18%" class="lcell"><@s.text name="view.fault.label.motionCounter" /></td>
		                            <td width="80%" colspan="3">${fault.motionCounter!""}</td>
		                        </tr>
		                        <tr>
		                            <td width="18%" class="lcell"><@s.text name="view.fault.label.errorNo" /></td>
		                            <td width="80%" colspan="3">${fault.errorNo!""}</td>
		                        </tr>
		                        <tr>
		                            <td width="18%" class="lcell"><@s.text name="view.fault.label.noRepon" /></td>
		                            <td width="80%" colspan="3">${fault.noRepon!""}</td>
		                        </tr>
		                        <tr>
		                            <td width="18%" class="lcell"><@s.text name="view.fault.label.otherDisplay" /></td>
		                            <td width="80%" colspan="3">${fault.otherDisplay!""}</td>
		                        </tr>
		                    </tbody>
		                </table>
		            </div>
		            <table width="80%" align="center" class="field_tbl">
		                <tbody>
		                    ...
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.cras" /></td>
		                        <td width="30%">
		                            <#if fault.cras?? && fault.cras == 1>
		                                <input type="radio" id="cras" name="fault.cras" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="cras" name="fault.cras" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.cras?? && fault.cras == 0>
		                                <input type="radio" id="cras" name="fault.cras" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="cras" name="fault.cras" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.dras" /></td>
		                        <td width="30%">
		                            <#if fault.dras?? && fault.dras == 1>
		                                <input type="radio" id="dras" name="fault.dras" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="dras" name="fault.dras" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.dras?? && fault.dras == 0>
		                                <input type="radio" id="dras" name="fault.dras" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="dras" name="fault.dras" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.mcuLog" /></td>
		                        <td width="30%">
		                            <#if fault.mcuLog?? && fault.mcuLog == 1>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.mcuLog?? && fault.mcuLog == 0>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.systemEvent" /></td>
		                        <td width="30%">
		                            <#if fault.systemEvent?? && fault.systemEvent == 1>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.systemEvent?? && fault.systemEvent == 0>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.dbillbox" /></td>
		                        <td width="30%">
		                            <#if fault.dbillbox?? && fault.dbillbox == 1>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.dbillbox?? && fault.dbillbox == 0>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.dcollect" /></td>
		                        <td width="30%">
		                            <#if fault.dcollect?? && fault.dcollect == 1>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.dcollect?? && fault.dcollect == 0>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.cfep" /></td>
		                        <td width="30%">
		                            <#if fault.cfep?? && fault.cfep == 1>
		                                <input type="radio" id="cfep" name="fault.cfep" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="cfep" name="fault.cfep" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.cfep?? && fault.cfep == 0>
		                                <input type="radio" id="cfep" name="fault.cfep" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="cfep" name="fault.cfep" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="view.fault.label.cerr" /></td>
		                        <td width="30%">
		                            <#if fault.cerr?? && fault.cerr == 1>
		                                <input type="radio" id="cerr" name="fault.cerr" value="1" checked disabled/><@s.text name="view.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="cerr" name="fault.cerr" value="1" disabled/><@s.text name="view.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.cerr?? && fault.cerr == 0>
		                                <input type="radio" id="cerr" name="fault.cerr" value="0" checked disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="cerr" name="fault.cerr" value="0" disabled/><@s.text name="view.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
