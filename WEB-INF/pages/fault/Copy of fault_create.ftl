...
function addRow() {
    ...
    if (iCurr < 15) {
        ...
        newTr += '<td><input type="text" name="faultSparesList['+ iCurr +'].no" maxLength="30" size="9" /></td>';
...
//setTime method1
  function openTimeWin(timeName){
    ...
    if(timeVal!="undefined" && timeVal!=""){
         var hour=timeVal.substring(0,2);
         var minute=timeVal.substring(2,4);
         $("#hour").val(hour);
         $("#minute").val(minute);
    }else{
        $("#hour").val("00");
                    ...
                    <td>         
			            <table width="80%" align="center" class="field_tbl">
			                <tbody>
			                    ...
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.brmEpVer" /></td>
			                        <td width="30%">${fault.brmEpVer!""}<input type="hidden" name="fault.brmEpVer" value="${fault.brmEpVer!""}"/></td>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.bvEpVer" /></td>
			                        <td width="30%">${fault.bvEpVer!""}<input type="hidden" name="fault.bvEpVer" value="${fault.bvEpVer!""}"/></td>
			                    </tr>
			                </tbody>
			            </table>
			                ...
			                <tbody>
			                    ...
			                    <tr>
			                        ...
			                        <td width="30%">
			                            ...
			                            &nbsp;<label class="needed"><@s.text name="input_needed" /></label>
			                           <input type="button"  onclick="openTimeWin('occurTime')"  class="input_button" style="margin:0 5px;width:60px;height:24px;line-height:24px;" value="<@s.text name="btn_set" />"/>
			                        </td>
			                    </tr>
			                    <tr>
			                ...
			                <tbody>
			                    ...
			                    <tr>
			                        ...
			                        <td width="80%" colspan="3">
			                            ...
			                            &nbsp;<label class="needed"><@s.text name="input_needed_before_finish" /></label>
			                            <input type="button"  onclick="openTimeWin('finishTime')"  class="input_button" style="margin:0 5px;width:60px;height:24px;line-height:24px;" value="<@s.text name="btn_set" />"/>
			                        </td>
			                    </tr>
			                </tbody>
			            </table>
			            <table style="margin-top:0px" width="80%" align="center" class="field_tbl">
			                <tbody>
			                    ...
			                    <tr>
			                        ...
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.rx278" /></td>
			                        <td width="10%"><input id="rx278" type="text" name="fault.rx278" value="${fault.rx278!""}" maxLength="4" size="4" /></td>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.counter" /></td>
			            ...
			            <div id="detailPhase" style="display:none;position:relative;">
			                ...
			                <table style="margin-top:0px" width="80%" align="center" class="field_tbl">
			                    <tbody>
			                        ...
			                        <tr>
			                            <td width="100%" colspan="2">
			                                <@s.text name="create.fault.label.msg3" />
			                        ...
			                        <tr>
			                            <td width="100%" colspan="2">
			                                <@s.text name="create.fault.label.msg5" /><br/>
			                                <@s.text name="create.fault.label.msg6" />
			                            </td>
			                        </tr>
			                        <tr>
			                        ...
			                        <tr>
			                            <td width="25%" class="lcell"><@s.text name="create.fault.label.otherDisplay" /></td>
			                            <td width="75%">
			            ...
			            <table width="80%" align="center" class="field_tbl">
			                <tbody>
			                    ...
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.cras" /></td>
			                        <td width="30%">
			                            <#if fault.cras?? && fault.cras == 1>
			                                <input type="radio" id="cras" name="fault.cras" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="cras" name="fault.cras" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.cras?? && fault.cras == 0>
			                                <input type="radio" id="cras" name="fault.cras" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="cras" name="fault.cras" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.dras" /></td>
			                        <td width="30%">
			                            <#if fault.dras?? && fault.dras == 1>
			                                <input type="radio" id="dras" name="fault.dras" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="dras" name="fault.dras" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.dras?? && fault.dras == 0>
			                                <input type="radio" id="dras" name="fault.dras" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="dras" name="fault.dras" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.mcuLog" /></td>
			                        <td width="30%">
			                            <#if fault.mcuLog?? && fault.mcuLog == 1>
			                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.mcuLog?? && fault.mcuLog == 0>
			                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.systemEvent" /></td>
			                        <td width="30%">
			                            <#if fault.systemEvent?? && fault.systemEvent == 1>
			                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.systemEvent?? && fault.systemEvent == 0>
			                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.dbillbox" /></td>
			                        <td width="30%">
			                            <#if fault.dbillbox?? && fault.dbillbox == 1>
			                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.dbillbox?? && fault.dbillbox == 0>
			                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.dcollect" /></td>
			                        <td width="30%">
			                            <#if fault.dcollect?? && fault.dcollect == 1>
			                                <input type="radio" id="dcollect" name="fault.dcollect" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="dcollect" name="fault.dcollect" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.dcollect?? && fault.dcollect == 0>
			                                <input type="radio" id="dcollect" name="fault.dcollect" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="dcollect" name="fault.dcollect" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                    </tr>
			                    <tr>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.cfep" /></td>
			                        <td width="30%">
			                            <#if fault.cfep?? && fault.cfep == 1>
			                                <input type="radio" id="cfep" name="fault.cfep" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="cfep" name="fault.cfep" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.cfep?? && fault.cfep == 0>
			                                <input type="radio" id="cfep" name="fault.cfep" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="cfep" name="fault.cfep" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                        <td width="20%" class="lcell"><@s.text name="create.fault.label.cerr" /></td>
			                        <td width="30%">
			                            <#if fault.cerr?? && fault.cerr == 1>
			                                <input type="radio" id="cerr" name="fault.cerr" value="1" checked/><@s.text name="create.fault.radio.label.has" />
			                            <#else>
			                                <input type="radio" id="cerr" name="fault.cerr" value="1"/><@s.text name="create.fault.radio.label.has" />
			                            </#if>
			                            <#if fault.cerr?? && fault.cerr == 0>
			                                <input type="radio" id="cerr" name="fault.cerr" value="0" checked/><@s.text name="create.fault.radio.label.hasnot" />
			                            <#else>
			                                <input type="radio" id="cerr" name="fault.cerr" value="0"/><@s.text name="create.fault.radio.label.hasnot" />
			                            </#if>
			                        </td>
			                    </tr>
			                    <tr>
			                        ...
			                        <td width="80%" colspan="3">
			                            <input id="others" type="text" name="fault.others" value="${fault.others!""}" maxLength="10" size="20" />
			                        </td>
			                    </tr>
			                </tbody>
			            </table>
				                ...
				                <tbody id="faultSparesTab_body">
				                    ...
				                    <#list faultSparesList as faultSpares>
				                        <tr id="tr_faultSpares${faultSpares_index}">
				                            ...
				                            <td><input type="text" name="faultSparesList[${faultSpares_index}].no" value="${faultSpares.no!""}" maxLength="30" size="9" /></td>
