                    ...
                    <td>         
                        <table width="80%" align="center" class="field_tbl">
                            <tbody>
                                ...
                                <tr>
                                    <td width="20%" class="lcell"><@s.text name="create.fault.label.gabio.mainEpver" /></td>
                                    <td width="30%">
                                       <input type="text" name="fault.mainEpver" value="${fault.mainEpver!""}" maxLength="20" size="20" />
                                     </td>
                                    <td width="20%" class="lcell"><@s.text name="create.fault.label.gabio.bidEpver" /></td>
                                    <td width="30%">
                        ...
                        <table style="margin-top:0px" width="80%" align="center" class="field_tbl">
                            <tbody>
                                ...
                                <tr>
                                    <td width="20%" class="lcell"><@s.text name="create.fault.label.gabio.ecErrorCode" /></td>
                                    <td width="30%"><input  type="text" name="fault.ecErrorCode" value="${fault.ecErrorCode!""}" maxLength="20" size="30" /></td>
                                    <td width="20%" class="lcell"><@s.text name="create.fault.label.gabio.mtcCode" /></td>
                        ...
                        <div id="detailPhase" style="display:none;position:relative;">
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%">
                                            <#if fault.cashControlLight?? && fault.cashControlLight == 1>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="1" checked/><@s.text name="create.fault.label.gabio.light.out" />
                                            <#else>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="1"/><@s.text name="create.fault.label.gabio.light.out" />
                                            </#if>
                                            <#if fault.cashControlLight?? && fault.cashControlLight == 2>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="2" checked/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            <#else>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="2"/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            </#if>
                                            <#if fault.cashControlLight?? && fault.cashControlLight == 3>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="3" checked/><@s.text name="create.fault.label.gabio.light.shine" />
                                            <#else>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="3"/><@s.text name="create.fault.label.gabio.light.shine" />
                                            </#if>
                                            <#if fault.cashControlLight?? && fault.cashControlLight == 4>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="4" checked/><@s.text name="create.fault.label.gabio.light.quickShine" />
                                            <#else>
                                                <input type="radio" id="cashControlLight" name="fault.cashControlLight" value="4"/><@s.text name="create.fault.label.gabio.light.quickShine" />
                                            </#if>
                                        </td>
                                        <td width="10%" class="lcell" colspan="3"><@s.text name="create.fault.label.gabio.faultLight" /></td>
                                        <td width="30%">
                                            <#if fault.faultLight?? && fault.faultLight == 1>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="1" checked/><@s.text name="create.fault.label.gabio.light.out" />
                                            <#else>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="1"/><@s.text name="create.fault.label.gabio.light.out" />
                                            </#if>
                                            <#if fault.faultLight?? && fault.faultLight == 2>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="2" checked/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            <#else>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="2"/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            </#if>
                                            <#if fault.faultLight?? && fault.faultLight == 3>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="3" checked/><@s.text name="create.fault.label.gabio.light.shine" />
                                            <#else>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="3"/><@s.text name="create.fault.label.gabio.light.shine" />
                                            </#if>
                                            <#if fault.cashControlLight?? && fault.faultLight == 4>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="4" checked/><@s.text name="create.fault.label.gabio.light.quickShine" />
                                            <#else>
                                                <input type="radio" id="faultLight" name="fault.faultLight" value="4"/><@s.text name="create.fault.label.gabio.light.quickShine" />
                                            </#if>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%" class="lcell" rowspan="2"><@s.text name="create.fault.label.gabio.statusDisplay" /></td>
                                        <td width="10%" class="lcell" colspan="3"><@s.text name="create.fault.label.gabio.shineLight" /></td>
                                        <td width="30%">
                                           <input type="text" id="shineLight" name="fault.shineLight" value="${fault.shineLight!""}" maxLength="80" size="30"/>
                                        </td>
                                        <td width="10%" class="lcell" colspan="3"><@s.text name="create.fault.label.gabio.stayShineLight" /></td>
                                        <td width="30%">
                                           <input type="text" id="stayShineLight" name="fault.stayShineLight" value="${fault.stayShineLight!""}" maxLength="80" size="30"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="10%" class="lcell" colspan="3"><@s.text name="create.fault.label.gabio.outLight" /></td>
                                        <td width="70%" colspan="5">
                                            <input id="outLight" type="text" name="fault.outLight" value="${fault.outLight!""}" maxLength="80" size="30" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%" class="lcell"><@s.text name="create.fault.label.gabio.onlineLight" /></td>
                                        <td width="10%" class="lcell" colspan="3"><@s.text name="create.fault.label.gabio.leftOnlineLight" /></td>
                                        <td width="30%">
                                            <#if fault.leftOnlineLight?? && fault.leftOnlineLight == 1>
                                                <input type="radio" id="leftOnlineLight" name="fault.leftOnlineLight" value="1" checked/><@s.text name="create.fault.label.gabio.light.out" />
                                            <#else>
                                                <input type="radio" id="leftOnlineLight" name="fault.leftOnlineLight" value="1"/><@s.text name="create.fault.label.gabio.light.out" />
                                            </#if>
                                           <#if fault.leftOnlineLight?? && fault.leftOnlineLight == 2>
                                                <input type="radio" id="leftOnlineLight" name="fault.leftOnlineLight" value="2" checked/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            <#else>
                                                <input type="radio" id="leftOnlineLight" name="fault.leftOnlineLight" value="2"/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            </#if>
                                           <#if fault.leftOnlineLight?? && fault.leftOnlineLight == 3>
                                                <input type="radio" id="leftOnlineLight" name="fault.leftOnlineLight" value="3" checked/><@s.text name="create.fault.label.gabio.light.shine" />
                                            <#else>
                                                <input type="radio" id="leftOnlineLight" name="fault.leftOnlineLight" value="3"/><@s.text name="create.fault.label.gabio.light.shine" />
                                            </#if>
                                     
                                        </td>
                                        <td width="10%" class="lcell" colspan="3"><@s.text name="create.fault.label.gabio.rightOnlineLight" /></td>
                                        <td width="30%">
                                            <#if fault.rightOnlineLight?? && fault.rightOnlineLight == 1>
                                                <input type="radio" id="rightOnlineLight" name="fault.rightOnlineLight" value="1" checked/><@s.text name="create.fault.label.gabio.light.out" />
                                            <#else>
                                                <input type="radio" id="rightOnlineLight" name="fault.rightOnlineLight" value="1"/><@s.text name="create.fault.label.gabio.light.out" />
                                            </#if>
                                           <#if fault.rightOnlineLight?? && fault.rightOnlineLight == 2>
                                                <input type="radio" id="rightOnlineLight" name="fault.rightOnlineLight" value="2" checked/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            <#else>
                                                <input type="radio" id="rightOnlineLight" name="fault.rightOnlineLight" value="2"/><@s.text name="create.fault.label.gabio.light.stayBright" />
                                            </#if>
                                           <#if fault.rightOnlineLight?? && fault.rightOnlineLight == 3>
                                                <input type="radio" id="rightOnlineLight" name="fault.rightOnlineLight" value="3" checked/><@s.text name="create.fault.label.gabio.light.shine" />
                                            <#else>
                                                <input type="radio" id="rightOnlineLight" name="fault.rightOnlineLight" value="3"/><@s.text name="create.fault.label.gabio.light.shine" />
                                            </#if>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table style="margin-top:0px" width="80%" align="center" class="field_tbl">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="100%" colspan="2">
                                            <@s.text name="create.fault.label.gabio.msg3" />
                                    ...
                                    <tr>
                                        <td width="25%" class="lcell"><@s.text name="create.fault.label.gabio.errorNo" /></td>
                                        <td width="75%">
                                            <input id="errorNo" type="text" name="fault.errorNo" value="${fault.errorNo!""}" maxLength="10" size="80" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="25%" class="lcell"><@s.text name="create.fault.label.gabio.noRepon" /></td>
                                        <td width="75%">
                                            <input id="noRepon" type="text" name="fault.noRepon" value="${fault.noRepon!""}" maxLength="40" size="80" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="25%" class="lcell"><@s.text name="create.fault.label.gabio.otherDisplay" /></td>
                                        <td width="75%">
