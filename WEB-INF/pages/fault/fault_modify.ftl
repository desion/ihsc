	              ...
	              <tr>
	                <td>         
		                ...
		                <tbody>
		                    ...
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.brmEpVer" /></td>
		                        <td width="30%"><input type="text" name="fault.brmEpVer" value="${fault.brmEpVer!""}" maxLength="20" size="20"/></td>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.bvEpVer" /></td>
		                        <td width="30%"><input type="text" name="fault.bvEpVer" value="${fault.bvEpVer!""}" maxLength="20" size="20"/></td>
		                    </tr>
		                </tbody>
		            </table>
		            ...
		            <table style="margin-top:0px" width="80%" align="center" class="field_tbl">
		                <tbody>
		                    ...
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.errorCode" /></td>
		                        <td width="20%"><input id="errorCode" type="text" name="fault.errorCode" value="${fault.errorCode!""}" maxLength="10" size="14" /></td>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.rx278" /></td>
		                        <td width="10%"><input id="rx278" type="text" name="fault.rx278" value="${fault.rx278!""}" maxLength="4" size="4" /></td>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.counter" /></td>
		                        <td width="10%"><input id="counter" type="text" name="fault.counter" value="${fault.counter!""}" maxLength="4" size="4" /></td>
		                    </tr>
		                    <tr>
		            ...
		            <div id="detailPhase" style="display:none;position:relative;">
		                <table style="margin-top:0px;margin-bottom:0px" width="80%" align="center" class="field_tbl">
		                    <tbody>
		                        ...
		                        <tr>
		                            ...
		                            <td width="15%" class="lcell" colspan="3"><@s.text name="modify.fault.label.cashLeft" /></td>
		                            <td width="25%">
		                                <#if fault.cashLeft?? && fault.cashLeft == 1>
		                                    <input type="radio" id="cashLeft" name="fault.cashLeft" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                                <#else>
		                                    <input type="radio" id="cashLeft" name="fault.cashLeft" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                                </#if>
		                                <#if fault.cashLeft?? && fault.cashLeft == 0>
		                                    <input type="radio" id="cashLeft" name="fault.cashLeft" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                                <#else>
		                                    <input type="radio" id="cashLeft" name="fault.cashLeft" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                                </#if>
		                            </td>
		                            <td width="15%" class="lcell" colspan="3"><@s.text name="modify.fault.label.exceptionDisplay" /></td>
		                            <td width="25%">
		                                <#if fault.exceptionDisplay?? && fault.exceptionDisplay == 1>
		                                    <input type="radio" id="exceptionDisplay" name="fault.exceptionDisplay" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                                <#else>
		                                    <input type="radio" id="exceptionDisplay" name="fault.exceptionDisplay" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                                </#if>
		                                <#if fault.exceptionDisplay?? && fault.exceptionDisplay == 0>
		                                    <input type="radio" id="exceptionDisplay" name="fault.exceptionDisplay" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                                <#else>
		                                    <input type="radio" id="exceptionDisplay" name="fault.exceptionDisplay" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                                </#if>
		                            </td>
		                        </tr>
		                        <tr>
		                            <td width="20%" class="lcell" rowspan="2"><@s.text name="modify.fault.label.screenDisplay" /></td>
		                            <td width="15%" class="lcell" colspan="3"><@s.text name="modify.fault.label.display" /></td>
		                            <td width="25%">
		                                <#if fault.display?? && fault.display == 1>
		                                    <input type="radio" id="display" name="fault.display" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                                <#else>
		                                    <input type="radio" id="display" name="fault.display" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                                </#if>
		                                <#if fault.display?? && fault.display == 0>
		                                    <input type="radio" id="display" name="fault.display" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                                <#else>
		                                    <input type="radio" id="display" name="fault.display" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                                </#if>
		                            </td>
		                            <td width="15%" class="lcell" colspan="3"><@s.text name="modify.fault.label.backLight" /></td>
		                            <td width="25%">
		                                <#if fault.backLight?? && fault.backLight == 1>
		                                    <input type="radio" id="backLight" name="fault.backLight" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                                <#else>
		                                    <input type="radio" id="backLight" name="fault.backLight" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                                </#if>
		                                <#if fault.backLight?? && fault.backLight == 0>
		                                    <input type="radio" id="backLight" name="fault.backLight" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                                <#else>
		                                    <input type="radio" id="backLight" name="fault.backLight" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                                </#if>
		                            </td>
		                        </tr>
		                        <tr>
		                            <td width="15%" class="lcell" colspan="3"><@s.text name="modify.fault.label.displayContent" /></td>
		                        ...
		                        <tr>
		                            <td width="20%" class="lcell"><@s.text name="modify.fault.label.touchBoardInput" /></td>
		                            <td width="15%" class="lcell" colspan="3"><@s.text name="modify.fault.label.inputable" /></td>
		                            <td width="25%">
		                                <#if fault.inputable?? && fault.inputable == 1>
		                                    <input type="radio" id="inputable" name="fault.inputable" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                                <#else>
		                                    <input type="radio" id="inputable" name="fault.inputable" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                                </#if>
		                                <#if fault.inputable?? && fault.inputable == 0>
		                                    <input type="radio" id="inputable" name="fault.inputable" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                                <#else>
		                                    <input type="radio" id="inputable" name="fault.inputable" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                                </#if>
		                            </td>
		                            <td width="15%" class="lcell" colspan="3"><@s.text name="modify.fault.label.knockSound" /></td>
		                            <td width="25%">
		                                <#if fault.knockSound?? && fault.knockSound == 1>
		                                    <input type="radio" id="knockSound" name="fault.knockSound" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                                <#else>
		                                    <input type="radio" id="knockSound" name="fault.knockSound" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                                </#if>
		                                <#if fault.knockSound?? && fault.knockSound == 0>
		                                    <input type="radio" id="knockSound" name="fault.knockSound" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                                <#else>
		                                    <input type="radio" id="knockSound" name="fault.knockSound" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                                </#if>
		                            </td>
		                        </tr>
		                    </tbody>
		                ...
		                <table style="margin-top:0px" width="80%" align="center" class="field_tbl">
		                    <tbody>
		                        ...
		                        <tr>
		                            <td width="100%" colspan="2">
		                                <@s.text name="modify.fault.label.msg3" />
		            ...
		            <table width="80%" align="center" class="field_tbl">
		                <tbody>
		                    ...
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.cras" /></td>
		                        <td width="30%">
		                            <#if fault.cras?? && fault.cras == 1>
		                                <input type="radio" id="cras" name="fault.cras" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="cras" name="fault.cras" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.cras?? && fault.cras == 0>
		                                <input type="radio" id="cras" name="fault.cras" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="cras" name="fault.cras" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.dras" /></td>
		                        <td width="30%">
		                            <#if fault.dras?? && fault.dras == 1>
		                                <input type="radio" id="dras" name="fault.dras" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="dras" name="fault.dras" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.dras?? && fault.dras == 0>
		                                <input type="radio" id="dras" name="fault.dras" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="dras" name="fault.dras" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.mcuLog" /></td>
		                        <td width="30%">
		                            <#if fault.mcuLog?? && fault.mcuLog == 1>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.mcuLog?? && fault.mcuLog == 0>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="mcuLog" name="fault.mcuLog" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.systemEvent" /></td>
		                        <td width="30%">
		                            <#if fault.systemEvent?? && fault.systemEvent == 1>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.systemEvent?? && fault.systemEvent == 0>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="systemEvent" name="fault.systemEvent" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.dbillbox" /></td>
		                        <td width="30%">
		                            <#if fault.dbillbox?? && fault.dbillbox == 1>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.dbillbox?? && fault.dbillbox == 0>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="dbillbox" name="fault.dbillbox" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.dcollect" /></td>
		                        <td width="30%">
		                            <#if fault.dcollect?? && fault.dcollect == 1>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.dcollect?? && fault.dcollect == 0>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="dcollect" name="fault.dcollect" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.cfep" /></td>
		                        <td width="30%">
		                            <#if fault.cfep?? && fault.cfep == 1>
		                                <input type="radio" id="cfep" name="fault.cfep" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="cfep" name="fault.cfep" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.cfep?? && fault.cfep == 0>
		                                <input type="radio" id="cfep" name="fault.cfep" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="cfep" name="fault.cfep" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                        <td width="20%" class="lcell"><@s.text name="modify.fault.label.cerr" /></td>
		                        <td width="30%">
		                            <#if fault.cerr?? && fault.cerr == 1>
		                                <input type="radio" id="cerr" name="fault.cerr" value="1" checked/><@s.text name="modify.fault.radio.label.has" />
		                            <#else>
		                                <input type="radio" id="cerr" name="fault.cerr" value="1"/><@s.text name="modify.fault.radio.label.has" />
		                            </#if>
		                            <#if fault.cerr?? && fault.cerr == 0>
		                                <input type="radio" id="cerr" name="fault.cerr" value="0" checked/><@s.text name="modify.fault.radio.label.hasnot" />
		                            <#else>
		                                <input type="radio" id="cerr" name="fault.cerr" value="0"/><@s.text name="modify.fault.radio.label.hasnot" />
		                            </#if>
		                        </td>
		                    </tr>
		                    <tr>
