		                ...
		                <tbody>
		                    <tr>
		                        <td style="border-top:0px;border-left:0px;border-right:0px;" colspan="6">
		                            <@s.text name="view.fault.label.gabio.atmFaultInfo" />
		                        </td>
		                    </tr>
		                    <tr>
		                ...
		                <table style="margin-top:0px;margin-bottom:0px;table-layout:fixed" width="100%" align="center" class="field_tbl">
		                    <tbody>
	                         <tr>
                                    ...
                                    <td width="10%" class="lcell"><@s.text name="create.fault.label.gabio.cashControlLight" /></td>
                                    <td width="30%">
                                    ...
                                    <td width="10%" class="lcell"><@s.text name="view.fault.label.gabio.faultLight" /></td>
                                    <td width="30%">
                                ...
                                <tr>
                                    ...
                                    <td width="10%" class="lcell"><@s.text name="view.fault.label.gabio.shineLight" /></td>
                                    <td width="30%" style="word-break:break-all;word-wrap:break-word;">${fault.shineLight!""}</td>
                                    <td width="10%" class="lcell"><@s.text name="view.fault.label.gabio.stayShineLight" /></td>
                                    <td width="30%" style="word-break:break-all;word-wrap:break-word;">${fault.stayShineLight!""}</td>
                                </tr>
                                <tr>
                                    <td width="10%" class="lcell"><@s.text name="view.fault.label.gabio.outLight" /></td>
                                    <td width="70%" colspan="3" style="word-break:break-all;word-wrap:break-word;">${fault.outLight!""}</td>
                                </tr>
                                <tr>
                                    <td width="18%" class="lcell"><@s.text name="view.fault.label.gabio.onlineLight" /></td>
                                    <td width="10%" class="lcell"><@s.text name="view.fault.label.gabio.leftOnlineLight" /></td>
                                    <td width="30%">
                                    ...
                                    <td width="10%" class="lcell"><@s.text name="view.fault.label.gabio.rightOnlineLight" /></td>
                                    <td width="30%">
			                               ...
			                               <div style="height:300px;overflow-y:scroll;overflow-x:hidden">
			                                  <table class="field_tbl" width="100%">
			                                    <tr>
			                                        ...
			                                        <td width="25%" class="lcell"><@s.text name="view.fault.label.gabio.ecErrorCode" /></td>
					                            ...
					                            <#list faultHistoryList as faultHistory>
					                                <tr>
					                                    ...
					                                    <td>${faultHistory.ecErrorCode!""}</td>
