...
<form id="viewForm" method="post" enctype ="multipart/form-data">
    <div id="view">
        <div class="fields">
            ...
            <table style="margin-bottom:0px;table-layout:fixed" width="100%" align="center" class="field_tbl">
                <tbody>
                    <tr>
            ...
            <div id="detailPhase" style="display:none;position:relative;">
                ...
                <table style="margin-top:0px;table-layout:fixed" width="100%" align="center" class="field_tbl">
                    <tbody>
                        ...
                        <tr>
                            <td width="20%" class="lcell"><@s.text name="view.fault.label.otherDisplay" /></td>
