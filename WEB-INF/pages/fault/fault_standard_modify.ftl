	              ...
	              <tr>
	                <td>         
		                ...
		                <tbody>
		                    ...
		                    <tr>
		                          <td width="20%" class="lcell"><@s.text name="modify.fault.label.standard.epVer" /></td>
		            ...
		            <div id="detailPhase" style="display:none;position:relative;">
		                ...
		                <table style="margin-top:0px" width="80%" align="center" class="field_tbl">
		                    <tbody>
		                        ...
		                        <tr>
		                            <td width="100%" colspan="2">
		                                <@s.text name="modify.fault.label.standard.msg3" />
		                        ...
		                        <tr>
		                            <td width="25%" class="lcell"><@s.text name="modify.fault.label.standard.otherDisplay" /></td>
		                            <td width="75%">
