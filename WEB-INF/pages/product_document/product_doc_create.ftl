...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(":checkbox[name='interfaceDocProCateList']").each(function(){
         ...
         $(":checkbox[name='interfaceDocProductList']").each(function(){
           $(this).click(function(){
               checkedNode(this);
           });
         });
    ...
    function checkChild(self){
      ...
      var self_id=$(self).attr("selfId"); 
      var level=$(self).attr("level");
      var selfChecked = $(self).attr("checked");
      if(level=="4"){
        //do nothing
      }else if(level=="3"){
        $(":checkbox[name='interfaceDocProductList'][parentId='"+self_id+"']").each(function(){
              if(selfChecked){
                 $(this).attr("checked","checked");
              }else{
