...
<head>
<title><@s.text name="city.modify" /></title>
 ...
 <#include "../header.ftl"/>
  <div id="view" >
    <div class="fields"  cellspacing="0" cellpadding="0"> 
      <form id="mdfForm" action="BS004_31" method="post">
        <table cellspacing="0" cellpadding="0" border="0" class="table_line2">
		           ...
		           <table align="center" width="60%" class="field_tbl" >
			         ...
			         <tr>
			          ...
			          <tr>
			             ...
			             <td> 
			               <select id="provinceDrop" name="city.provinceId" >
           ...
           <input type="hidden" name="city.exclusiveKey" value="${city.exclusiveKey!""}"  />
           <input type="hidden" name="currPage" value="${currPage!0}" />
           <input type="hidden" name="pageSize" value="${pageSize!0}" />
       </form>
        <div class="btn_row">
            <#if loginUser.hasPermission("BS004_31")>
              <button type="button" onClick="changeAction('BS004_31')" ><@s.text name="btn_modify" /></button>
            </#if>  
        </div> 
      </div>
    </div>
