...
<head>
<title><@s.text name="installation_apply_create" /></title>
    ...
    <div id="view" >
        <div class="fields">
            <form id="instApplyForm" method="post">
	                      ...
	                      <tr>
	                        <td>                    
					            <table  width="90%" align="center" class="field_tbl" style="table-layout:fixed">
					                <tbody>
						                <tr>
						                    <td  width="18%" class="lcell" ><label><@s.text name="productCategory" /></label></td>
						                    ...
						                    <td  width="18%" class="lcell" ><label><@s.text name="productModel" /></label></td>
                                      ...
                                      <tr>
					                    ...
					                    <#if install.faultMachineType?? && install.faultMachineType=="G-ABIO"> 
                                            ...
                                            <tr>
                                                ...
                                                <input type="hidden" value="${install.deskey!""}" name="deskey" >
                                            </tr>
                                            <tr>
                ...
                <input type="hidden" value="${install.id!""}" name="install.id" >
                <input type="hidden" name="install.faultMachineType" value="${install.faultMachineType!""}" />
            </form>
			<div class="btn_row">
			<#if loginUser.hasPermission("PR004_21")>
			    <button type="button" onClick="changeAction('PR004_21')" ><@s.text name="btn_add" /></button>
			</#if>
			</div>
        </div>
    </div>
