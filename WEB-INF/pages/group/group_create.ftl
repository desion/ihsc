...
<head>
<title><@s.text name="group.create" /></title>
 ...
 <#include "../components/error_reference.ftl"/>
   <div id="container" >
     <#include "../header.ftl"/> 
	     <div id="view">
	      <div class="fields"> 
	       <form id="mdfForm" action="BS006_21" method="post"> 
	              ...
	              <tr>
	                <td> 	     
				       <table width="70%" class="field_tbl" align="center">
					     <tr>
			                 <td width="20%" class="lcell"><label><@s.text name="group.name" /></label></td>
						     <td width="80%">
						       <input type="text" name="group.name"  value="${group.name!""}"  size="40" maxLength="40"/>
						       <label class="needed"><@s.text name="input_needed" /></label>
						     </td>
					      </tr>
					      <tr>
						      <td class="lcell"><label><@s.text name="group.description"  /></label></td>
						      <td><input type="text" name="group.description"  value="${group.description!""}" size="40" maxLength="80"/></td>
					      </tr>
				       </table>
	                </td>
	              </tr>
                  ...
                  <tr>
                    <td>              
					    <table  class="field_tbl" width="70%" cellspacing="0" cellpadding="0" >
				           <tr>
				             <th width="12%" ><input type="checkbox" id="selectAll" /><label><@s.text name="select_all" /></label></td>
				             <th width="88%"  style="text-align:center" align="center" ><label><@s.text name="group.accessList" /></label></td>
				           </tr>
				           <tr>
				             <td colspan="2" >
	   ...
	   <div class="btn_row" >
	    <#if loginUser.hasPermission("BS006_21")>       
           <button type="button" onClick="changeAction('BS006_21')" ><@s.text name="btn_add" /></button>
        </#if>
      </div>
     </div> 
    </div>
