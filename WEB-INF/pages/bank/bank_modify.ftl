...
<head>
<title><@s.text name="bank.modify" /></title>
 ...
 <#include "../header.ftl"/>
  <div id="view" >
    <div class="fields"  cellspacing="0" cellpadding="0"> 
      <form id="mdfForm" action="BS012_31" method="post">
        <table cellspacing="0" cellpadding="0" border="0" class="table_line2">
           ...
           <input type="hidden" name="bank.exclusiveKey" value="${bank.exclusiveKey!""}"  />
       </form>
        <div class="btn_row">
            <#if loginUser.hasPermission("BS012_31")>
              <button type="button" onClick="changeAction('BS012_31')" ><@s.text name="btn_modify" /></button>
            </#if>  
        </div> 
      </div>
    </div>
